...
from .io.neonrad import open_neon
...
class HyTools:
    ...
    def load_data(self, mode = 'r'):
        ...
        elif self.file_type  == "neonrad":
            self.hdf_obj = h5py.File(self.file_name,'r')
            self.data = self.hdf_obj[self.base_key]["Radiance"]["Radiance_total"]
    ...
    def get_anc(self,anc,radians = True,mask = None):
        ...
        if self.file_type == "envi":
            ...
            metadata = hdf_obj[self.base_key]["Radiance"]["Metadata"]
